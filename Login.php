...
$Uname = "GGNEALZ CODM Garena Script.lua";  //Script Name
$Url1 = "https://raw.githubusercontent.com/Aldreeech/panelskrepptcodmgrsluggr/refs/heads/main/Register.php"; //Register.php Link
$Url2 = "https://raw.githubusercontent.com/Aldreeech/panelskrepptcodmgrsluggr/refs/heads/main/User.php"; //User.php Link
$Url3 = "https://raw.githubusercontent.com/Aldreeech/panelskrepptcodmgrsluggr/refs/heads/main/ActionManager.php"; //ActionManager.php Link
...
if($content[devil99encode($username)]   <> null){
	...
	if($content[devil99encode($username)]["password"] == devil99encode($password)){
		...
		return;
					...
					ExitAlert("! Key 1 Device!, Contact @cresttpk on Telegram to reset Your Key!");
					
					}
					}
					else{
					ExitAlert("⚠ Offline Account, contact @cresttpk On telegram");
					return;
					}
				...
				ExitAlert("Subscription Expired, AVAIL KA NA ULIT!");
		...
		ExitAlert("User is not Registered.");
		return;
		}
?>